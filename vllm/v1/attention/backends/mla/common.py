...
def reorg_kvcache(
    ...
    for dcp_chunk_seq_len, origin_context_len, local_context_lens in zip(
        dcp_chunk_seq_lens_lst, origin_context_lens, local_context_lens_allrank
    ):
        ...
        for rank in range(dcp_world_size):
            real_dcp_chunk_seq_len = local_context_lens[rank]
            if real_dcp_chunk_seq_len != 0:
